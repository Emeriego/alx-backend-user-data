...
def index() -> str:
    """ This is the index route of the API
...
def users() -> str:
    """
    Register a user by creating a new user in the database
    """
...
def login() -> str:
    """
    Log in a user by creating a session_id cookie
    """
    email = request.form.get("email")
    password = request.form.get("password")
...
def logout():
    """
    Log out a user by destroying the session_id
    """
...
def get_reset_password_token() -> str:
    """
    The user receives a password reset token if the email is registered
    """
    email = request.form.get("email")
    try:
